...
export default async function EmbaixadorPage({
  ...
  const checklists = listarChecklistsDoSetor(usuario.setor_id!, lerPagina(pagina));
  const abertos = listarChecklistsPorStatus(usuario.setor_id!, "aberto").total;
        ...
        <section className="flex flex-col gap-3">
          ...
          {checklists.total === 0 ? (
            ...
            <>
              ...
              <Paginacao
                base="/embaixador"
                pagina={checklists.pagina}
                paginas={checklists.paginas}
